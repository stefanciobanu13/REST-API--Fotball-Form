package com.teamsapp.springboot.TeamsApp.rest;

import com.teamsapp.springboot.TeamsApp.dto.*;
...
public class RestController {
    ...
    @Autowired
    private TeamService2 teamService2;
    ...
    @PostMapping("/rounds")
    public String saveRound(@RequestBody RoundDTO roundDTO) {
        roundService.saveRound(roundDTO);
    ...
    public String saveGame(@RequestBody GameDTO gameDTO) {
        ...
        return "The game with the id " + gameDTO.getId() + " was saved";
    }
